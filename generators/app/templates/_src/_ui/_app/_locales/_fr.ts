...
export const fr = {
    ...
    signup: {
        title: 'S\'inscrire',
        instruction: 'Inscrivez-vous pour un compte',
        placeholder: {
            displayName: '',
            userName: 'Entrez votre nom d\'affichage',
            password: 'Tapez votre mot de passe',
    ...
    site: {
        copyright: '© Droits d\'auteur 2058, <%=assemblyName%> Société'
    },
    user: {
